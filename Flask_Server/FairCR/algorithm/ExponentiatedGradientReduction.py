...
class AIF_ExponentiatedGradientReduction():
    """
    information [...]
    ...
    def fit(self, X_train, y_train):
        ...
        self.model = ExponentiatedGradientReduction(self.classifier, self.metric, eps=self.eps, eta0=self.lr, drop_prot_attr=drop_prot_attr)
